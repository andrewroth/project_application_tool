...
) ENGINE=InnoDB AUTO_INCREMENT=647876 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=14661 DEFAULT CHARSET=latin1;
...
CREATE TABLE `profile_prep_items` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7625 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=5425 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=28263 DEFAULT CHARSET=latin1 COMMENT='Truncated and re-loaded nightly by a DTS package on NUMBERS';
...
) ENGINE=InnoDB AUTO_INCREMENT=8089 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=423371 DEFAULT CHARSET=latin1;
